...
> Automatically extracts accounts from **Minecraft, Steam, Discord, and Windows Users**.
*   **:mag: Smart "Fuzzy" Target Search**
> Uses an intelligent algorithm to find username variations (`TheGamer` / `Th3_G4m3r_01`) and typos that standard searches miss.
*   **:floppy_disk: Advanced Forensics (USN Journal)**
> Retrieves a detailed history of **deleted and modifided mc related files** over the last 14 days, exposing cleaning attempts.

### :chart_with_upwards_trend: Optimized Performance

*   **:rocket: Deep & Fast:** Scans gigabytes of data in few seconds.
